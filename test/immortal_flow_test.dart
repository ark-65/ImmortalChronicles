...
void main() {
  test('Immortal high-luck flow hits cultivation events', () {
    ...
    // Fast-forward到6岁执行觉醒
    state.age = 6;
    final rootEvent = engine.pickEvent(state);
    ...
    state.age = 7;
    final famEvent = engine.pickEvent(state);
    ...
    for (var i = 0; i < 10; i++) {
      final ev = engine.pickEvent(state);
